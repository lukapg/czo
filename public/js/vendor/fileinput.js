    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            self.defaults = {
                ...
                previewTemplates: {},
                previewSettings: {
                    image: {width: "auto", height: "160px !important"},
                    html: {width: "213px", height: "160px !important"},
                    text: {width: "213px", height: "160px !important"},
                    video: {width: "auto", height: "100%", 'max-width': "100%"},
                    audio: {width: "100%", height: "30px"},
                    flash: {width: "auto", height: "100%", 'max-width': "100%"},
                    object: {height: "100%"},
                    pdf: {width: "160px", height: "160px !important"},
                    other: {width: "160px", height: "160px !important"}
                },
                previewZoomSettings: {
