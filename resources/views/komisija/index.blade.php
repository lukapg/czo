...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex justify-content-between align-items-center">
          <h6 class="m-0 font-weight-bold text-primary">Komisija</h6>
          @if(auth()->user()->rola_id == 1 || auth()->user()->rola_id == 2)
          <a href="{{ route('komisija.create') }}" class="btn btn-success">Novi član komisije</a>
          @endif
        </div>
        <div class="card-body">
